...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
  ...
  describe('making orders', async () = {
    ...
    it('tracks the newly created order', async () => {
      const orderCoutn = await exchange.orderCount()
      ...
      order.tokenGive.should.equal(ETHER_ADDRESS, 'token is correct')
    ...
    it('emits an "Order" event', async () => {
      ...
      event.amountGet.toString().should.equal(ether(1).toString(), 'amountGive is correct')
